...
public class UpProgressDialog extends Dialog implements ProgressListener {
    private Context context;
    private Activity mActivity;
    private String msg; //跟随Dialog 一起显示的message 信息！
    private TextView mTextView;
    private ProgressBar mProgressBar;
    public UpProgressDialog(@NonNull Context context, int themeResId, String msg,Activity activity) {
