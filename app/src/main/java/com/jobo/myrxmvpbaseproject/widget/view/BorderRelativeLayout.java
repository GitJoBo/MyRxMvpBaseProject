...
public class BorderRelativeLayout extends RelativeLayout {
    ...
    public BorderRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderBottomLeftBreakSize = ta.getDimensionPixelSize(R.styleable
                .BorderRelativeLayout_borderBottomLeftBreakSize, 0);
        mBorderBottomRightBreakSize = ta.getDimensionPixelSize(R.styleable
                .BorderRelativeLayout_borderBottomRightBreakSize, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (isNeedBottomBorder) {
            canvas.drawLine(mBorderBottomLeftBreakSize, this.getHeight(), this.getWidth() -
                    mBorderBottomRightBreakSize, this.getHeight(), mPaint);
        }
