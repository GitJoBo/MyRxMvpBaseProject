...
//    public static final int noneNet=-1;
    ...
    public static boolean isNetAndShow() {
        if (!isNetworkConnected()) {
            ToastUtils.showToast(R.string.line_net);
            return false;
        }
        if (!isNetworkAvailable()) {
            ToastUtils.showToast(R.string.net_no_available);
            return false;
        }
        return true;
    }
    ...
    public static boolean isNetworkConnected() {
        ...
        {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) HttplibApp.sContext
...
//    }
    ...
    public static NetworkInfo[] getWorkInfos() {
        ConnectivityManager cm = (ConnectivityManager) HttplibApp.sContext.getSystemService(Context.CONNECTIVITY_SERVICE);
